...
TPS65090_PDATA_INIT(DCDC1, dcdc1, NULL, 0, 1, 0, true, -1, 1000/*-1*/);
TPS65090_PDATA_INIT(DCDC2, dcdc2, NULL, 0, 1, 0, true, -1, -1);
TPS65090_PDATA_INIT(DCDC3, dcdc3, NULL, 0, 1, 0, true, -1, -1);
...
PALMAS_REG_INIT(regen2, 0, 0/*PALMAS_EXT_CONTROL_NSLEEP*/, 0, 0, 0);
...
static struct regulator_consumer_supply fixed_reg_en_3v3_cam_e1611_supply[] = {
	REGULATOR_SUPPLY("vdd_cam_3v3", NULL),
	REGULATOR_SUPPLY("vi2c", "2-0030"),
	REGULATOR_SUPPLY("vif", "2-0036"),
	REGULATOR_SUPPLY("dovdd", "2-0010"),
	REGULATOR_SUPPLY("vdd_i2c", "2-000e"),
...
FIXED_REG(7,	en_3v3_cam_e1611,	en_3v3_cam_e1611,
	palmas_rails(smps3),	0,	0,
	PALMAS_TEGRA_GPIO_BASE + PALMAS_GPIO6,	false,	true,	0,	3300);
...
FIXED_REG(9,	lcd_bl_en,	lcd_bl_en,
	NULL,	0,	0,
	TEGRA_GPIO_PH2,	false,	false,	0,	5000);
#endif	
...
#define E1611_FIXED_REG				\
	ADD_FIXED_REG(en_3v3_cam_e1611), \
