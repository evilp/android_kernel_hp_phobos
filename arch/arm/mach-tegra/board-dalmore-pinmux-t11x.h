...
#if PHOBOS_USB_1_HOST
	USB_PINMUX(USB_VBUS_EN0, USB, PULL_UP, NORMAL, OUTPUT, DISABLE, ENABLE),
#else
...
static struct gpio_init_pin_info init_gpio_mode_dalmore_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH2, true, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PK4, false, 0),	// GMI_CS3
#endif
