...
{
	struct board_info board_info;
       int disable_default_touch = 1;   //WOLO_BSP --- remove un-used touch
	...
	dalmore_edp_init();
       ...
       if(disable_default_touch == 0)
	   	dalmore_touch_init();  //WOLO_BSP --- remove un-used touch
...
#if 0  //WOLO_BSP ---Phobos didn't have power monitor sensor, disable it.
	dalmore_pmon_init();
#endif 
