...
#if 1 //wolo_vh:key define
static struct gpio_keys_button dalmore_e1611_1001_keys[] = {
	[0] = GPIO_KEY(KEY_POWER, PQ0, 1),
	[1] = GPIO_KEY(KEY_VOLUMEUP, PR2, 0),//KB_ROW2
	[2] = GPIO_KEY(KEY_VOLUMEDOWN, PR1, 0),//KB_ROW1	
	[3] = GPIO_KEY(KEY_BRIGHTNESSUP, PQ1, 0),//KB_COL1
	[4] = GPIO_KEY(KEY_BRIGHTNESSDOWN, PQ2, 0),//KB_COL2
};
#else
static struct gpio_keys_button dalmore_e1611_1001_keys[] = {
	[0] = GPIO_KEY(KEY_POWER, PQ0, 1),
