...
static u8 dsi2lvds_config_dsi[][2] = {
	...
	DSI2LVDS_REG_VAL(0x12,0x55), /* channel A clk range */
...
static u8 dsi2lvds_config_video[][2] = {
	...
	DSI2LVDS_REG_VAL(0x24, 0x38), /* vertical pixels on lvds channel A */
	DSI2LVDS_REG_VAL(0x25, 0x04),
	DSI2LVDS_REG_VAL(0x26, 0x38), /* vertical pixels on lvds channel B */
	DSI2LVDS_REG_VAL(0x27, 0x04),
	DSI2LVDS_REG_VAL(0x28, 0x15), /* Pixel clk delay from dsi to */
	DSI2LVDS_REG_VAL(0x29, 0x00), /* lvds channel A */
	DSI2LVDS_REG_VAL(0x2a, 0x15), /* Pixel clk delay from dsi to */
	DSI2LVDS_REG_VAL(0x2b, 0x00), /* lvds channel B */
	DSI2LVDS_REG_VAL(0x2c, 0x05), /* hsync width channel A */
	DSI2LVDS_REG_VAL(0x2d, 0x00),
	DSI2LVDS_REG_VAL(0x2e, 0x05), /* hsync width channel B */
	DSI2LVDS_REG_VAL(0x2f, 0x00),
	DSI2LVDS_REG_VAL(0x30, 0x01), /* vsync width channel A */
	DSI2LVDS_REG_VAL(0x31, 0x00),
	DSI2LVDS_REG_VAL(0x32, 0x01), /* vsync width channel B */
...
#if foxconn_Display_Debug	
	pr_warn("tegra_dsi2lvds_enable++++++++tegra_dsi2lvds_enable\n");
#endif	 
...
{
	struct tegra_dc_dsi2lvds_data *dsi2lvds = tegra_dsi_get_outdata(dsi);	
	pr_warn("tegra_dsi2lvds_disable\n");
	//lvds_suspend = true ;
