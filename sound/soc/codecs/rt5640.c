...
//b-{RT5640_HP_VOL		, 0x8888},/* OUTMIX -> HPVOL */
	{RT5640_HP_VOL		, 0x8a8a},//b+ -3.0db = (8-a) * 1.5	
...
//b-	{RT5640_SPO_CLSD_RATIO	, 0x0001},
...
//b-{RT5640_IN3_IN4		, 0x0500},/*IN2 boost 40db & signal ended mode*/
	{RT5640_IN3_IN4		, 0x0700},//b+ hp_mic 5(40db),6(44),7(50),8(52)
...
static const u16 rt5640_reg[RT5640_VENDOR_ID2 + 1] = {
	...
	[RT5640_CHARGE_PUMP] = 0x0f00, //b- 0x0d00,
...
//b- #define VOL_RESCALE_MIX_RANGE 0x1F /* 31 */
#define VOL_RESCALE_MIX_RANGE 0x23 //b+
